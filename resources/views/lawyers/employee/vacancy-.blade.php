...
@section('content')
                        ...
                        'template' => "
                            ...
                            <div class='response-info'>
                                <ul>
                                    ...
                                    <li><span>Цена заказа</span><span>18,000 &#8381;</span></li>
                                </ul>
    ...
    <section class="u-container response-section section--lawyer-response" id="response_form" hidden="true">
        <div class="container">
            <div class="lawyer-responce_card">
                <div class="lawyer-responce_inner">
                    ...
                    <form action="#" class="form--lawyer-response">
                        <textarea id="response_text" class="form--lr-textarea" placeholder="Введите сопроводительный текст..."></textarea>
                        <div class="flex align-center form--group">
                            <span class="form--group_heading">Стоимость услуги</span>
                            <input id="response_price" type="number" placeholder="Сумма" class="form--field">
                            <span>рублей</span>
                        </div>
                        <div class="flex align-center form--group">
                            <span class="form--group_heading">Срок</span>
                            <input id="response_period" type="number" placeholder="Число" class="form--field">
                            <span>дней</span>
                        </div>
                        <button id="respond" type="submit" class="main-btn main-btn_blue form--lr_submit">Отправить</button>
