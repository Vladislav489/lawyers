...
<script src="/js/component/selectComponent/multiSelect.js"></script>
@endPushOnce
@if(!$include)
    @php
        if(strpos($name,'view_component_') !== false)$name = uniqid(str_replace('view_component_','',$name));
    @endphp
    <component id="component_multiSelectComponent_{{$name}}" data-name="{{$name}}">
                ...
                <script date-id_script="{{$name}}">
                    ...
                    $(document).ready(function() {
                        ...
                        var params_{{$name}} = {
                            ...
                            'selectItemStart':@php echo isset($selectItemStart)? json_encode($selectItemStart):'null'; @endphp,
                        ...
                        var component_{{$name}}  = new multiSelectComponent('#component_{{$name}}', params_{{$name}})
