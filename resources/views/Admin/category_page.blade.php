...
@push('content')
            ...
            <div style='width:700px' class='modal-content'>
                ...
                <div class='modal-body' style="width:700px">
                    <div class="flex-between">
                        <div><p>Название категории</p><input class="search-input-admin"  name="name_edit" type="text"></div>
                        <div><p>Родитель</p>
                            @include('component_build',[
                            'component' => "component.listComponent.selectComponent",
                            'params_component' => [
                               "autostart" => 'true',
                               "name" => 'parent_id_edit',
                               "default_title" => 'Выбрать',
                               "url" => route("actionGetListCategorySelect_admin_mainstay_backcontroller"),
                    ...
                    <div class='flex-between'>
                        <div><p>Сайт</p>
                            @include('component_build',["component" =>'component.listComponent.selectComponent',
                              ...
                              "name" => 'site_id_edit',
                              "default_title" => 'Выбрать',
                              "url" => route("actionGetListSiteSelect_admin_mainstay_backcontroller"),
                              "template" => 'simpleSelect',
                              "change" => "function(){}"
                            ]])
                        </div>
                        <div>
                            <p>Группа</p>
                            <input class='search-input-admin' name='group_edit' type='text'>
                        </div>
                    </div>
                    <div class='flex-between'>
                        <div><p>Сортировка</p>
    ...
    "autostart" => 'true',
    "name" => "routes",
    "url" => route("actionGetListCategory_admin_mainstay_backcontroller"),
    ...
    <script>
        ...
        function Init() {
            ...
            $("#editDialog_saveEdit").click(function(){SaveDoamin()});
        ...
        function SaveDoamin() {
            ...
            page__.sendData("{{route__("actionCategorySave_admin_mainstay_backcontroller")}}",
        ...
        function DeleteItem(id){
            if(confirm("Точно хотите удалить ?")){
                page__.sendData("{{route__("actionCategoryDelete_admin_mainstay_backcontroller")}}",
                    {'id':id},function(data){
                        if(data['result'] == 0){
