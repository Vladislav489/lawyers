  ...
  CKEDITOR.plugins.add("spotify", {
    ...
    init: function (editor) {
      ...
      editor.widgets.add("spotify", {
        ...
        allowedContent:
          "div[!data-embed-code](!spotify-playlist-wrapper,align-left,align-right,align-center){width,height};" +
          "iframe[allow,frameborder,allowtransparency,!width,!height](!no-border)",
        requiredContent:
          "div(!spotify-playlist-wrapper);" +
          "iframe[allow,frameborder,allowtransparency,!width,!height](!no-border)",
